...
ALTER TABLE "Таблица"
	ADD CONSTRAINT "Таблица_FОрга_7449" FOREIGN KEY ("Организация") REFERENCES "Организация" ("primaryKey");

CREATE INDEX "Таблица_IОрга_9156" on "Таблица" ("Организация");

ALTER TABLE "Таблица"
	ADD CONSTRAINT "Таблица_FСотру_114" FOREIGN KEY ("Сотрудник") REFERENCES "Сотрудник" ("primaryKey");

CREATE INDEX "Таблица_IСотру_560" on "Таблица" ("Сотрудник");
