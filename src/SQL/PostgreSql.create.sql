...
CREATE INDEX Index797f1bc23b6a07dc3183dcc5f913cf5148c2737d on Увольнение (Организация); 
 ...
 ALTER TABLE Таблица ADD CONSTRAINT FKcdbc838306796d34e420b77ea2f08d18cc98254e FOREIGN KEY (Организация) REFERENCES Организация; 
CREATE INDEX Indexcdbc838306796d34e420b77ea2f08d18cc98254e on Таблица (Организация); 

 ALTER TABLE Таблица ADD CONSTRAINT FK25487e3e1ec383208c7eee7e4d1752092163a776 FOREIGN KEY (Сотрудник) REFERENCES Сотрудник; 
CREATE INDEX Index25487e3e1ec383208c7eee7e4d1752092163a776 on Таблица (Сотрудник); 
